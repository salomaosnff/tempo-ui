...
export const PagerSymbol = Symbol("Pager");
...
/**
 * Check if a value is a Pager
 */
export function isPager<T = any>(val: any): val is Pager<T> {
  return !!val && typeof val === "object" && !!val[PagerSymbol];
}
