 ...
 */
export async function waitEmit<T extends AnyFunction>(handler?: T, ...args: Parameters<T>): Promise<Awaited<ReturnType<T>>>
export async function waitEmit<T extends AnyFunction>(handlers?: T[], ...args: Parameters<T>): Promise<Awaited<ReturnType<T>>[]>
export async function waitEmit(handlerOrHandlers?: AnyFunction | AnyFunction[], ...args: any[]): Promise<any> {
